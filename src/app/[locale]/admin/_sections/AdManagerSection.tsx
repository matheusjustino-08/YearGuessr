            ...
            {proposals.map(prop => (
              <div key={prop.id} className="p-4 rounded-xl bg-card border border-border/60 space-y-2 shadow-xs">
                ...
                <div className="flex items-center gap-2 pt-1">
                  ...
                  {prop.linkedin && (
                    <a
                      href={prop.linkedin.startsWith('http') ? prop.linkedin : `https://${prop.linkedin}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="py-1 px-2.5 rounded-lg bg-sky-600 hover:bg-sky-500 text-white font-bold text-[10px] flex items-center gap-1 cursor-pointer"
                    >

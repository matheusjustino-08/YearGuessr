...
export default function NotFound() {
  return (
    <div className="min-h-[85vh] flex flex-col items-center justify-center text-center px-4 font-sans relative overflow-hidden selection:bg-amber-500/30 selection:text-amber-400">

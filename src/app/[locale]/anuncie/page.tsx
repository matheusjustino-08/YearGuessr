...
export default function AdvertiseSalesPage() {
  ...
  const handleCheckDate = (e: React.FormEvent) => {
    ...
    // Simulate availability check (dates in the future are available)
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-4 py-8 space-y-16">
        ...
        <section className="space-y-6 max-w-3xl mx-auto pt-4">
          ...
          <div className="space-y-3">
            ...
            <div className="p-5 rounded-2xl bg-card border border-border/60 space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Fornecemos um link de relatório de desempenho com dados em tempo real de visualizações, cliques concretos e taxa de clique (CTR %).
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-amber-500/15 via-card to-emerald-500/15 border border-amber-500/30 text-center space-y-6 relative overflow-hidden">
          <div className="max-w-2xl mx-auto space-y-3">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground">Fale diretamente com nossa equipe via WhatsApp ou envie uma proposta por e-mail.</p>
          </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-card border border-border/80 p-6 sm:p-8 rounded-3xl max-w-lg w-full space-y-5 shadow-2xl relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">Preencha seus dados para receber o mídia kit completo e valores.</p>
            </div>

            {formSent ? (
              <div className="p-6 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-center space-y-2">
                <CheckCircle2 className="w-8 h-8 text-emerald-500 mx-auto" />
                <p className="text-sm font-bold text-foreground">Proposta Enviada com Sucesso!</p>
                <p className="text-xs text-muted-foreground">Entraremos em contato no seu e-mail em até 24 horas.</p>
              </div>
            ) : (
              <form onSubmit={handleFormSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full py-3 rounded-2xl bg-amber-500 text-black font-bold text-xs uppercase tracking-wider shadow-md hover:bg-amber-400 transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-98"
                >
